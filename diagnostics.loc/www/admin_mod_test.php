...
<body>
    ...
    <div class="container-fluid vendorfontfamily size_data1">
        ...
        <a class="button_back" href="administrator_mode.php"><button class="btn btn-info btn-lg btn-block button_back_btn">Назад</button></a>
        ...
        <div class="row">
            ...
            <table class="table-responsive table-bordered table-sm vendorfontfamily1">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">Названия теста</th>
    ...
    <div class="container-fluid">
        <div class="row d-flex justify-content-center container_row_button">
            ...
            if ($page > 1) {
                echo "<a href='admin_mod_test.php?page=" . ($page - 1) . "' class='btn btn-primary row_button_size'>Назад</a>";
            }

            for ($i = 1; $i < $total_page; $i++) {
                echo "<a href='admin_mod_test.php?page=" . $i . "' class='btn btn-primary row_button_size'>$i</a>";
            }

            if ($i > $page) {
                echo "<a href='admin_mod_test.php?page=" . ($page + 1) . "' class='btn btn-primary row_button_size'>Вперед</a>";
            }
